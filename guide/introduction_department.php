...
<html lang="kr">
 ...
 <body>
  <?php
	...
	$sql = "select idx,id,name,title,date from introduction order by idx desc";
...
<!--lnb end-->
	...
	<div class="content">
		...
		<h4 class="content_title">게임영상과 / 유비쿼터스과</h4>
		</div>
		<table class="board_list">
			...
			?>	
				<tr>
					...
					if($_SESSION['id']==true){	
					?>
					<td class="btitle"><a href="./sh_intro.php?idx=<?=$row['idx']?>"><?=$row['title']?></td>
					<?php
					}else{
					?>
			...
			if($_SESSION['id']==true){
			?>
				<a href="id_write.php"><div class="write" align="center">글쓰기</div></a>
			<?php
			}else{
			?>
