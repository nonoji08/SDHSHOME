...
<!--lnb end-->
	<div class="content">
		...
		<form action="./paper_write_add.php" method="post" id="frm">
		<ul>
					<li>H</li>
					<li>입학안내</li>
					<li>글쓰기</li>
			...
			<a href="http://52.78.55.166/notice/paper.php"><button type="button" class="write" style="float:left">글목록</button></a>
	    </form>
	</div>	
 </main>
<!--footer include -->
