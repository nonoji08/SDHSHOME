...
<html lang="kr">
 <head>
  ...
  <script type="text/javascript" src="../guide/se/js/HuskyEZCreator.js" charset="utf-8"></script>
</script>
 </head>
 <body>
 <header>
...
<!--lnb end-->
	<div class="content">
		...
		<form action="./notice_write_add.php" method="post" id="frm">
		<ul>
					<li>H</li>
					<li>입학안내</li>
					<li>글쓰기</li>
			...
			<a href="http://52.78.55.166/notice/notice.php"><button type="button" class="write" style="float:left">글목록</button></a>
	    </form>
	</div>	
 </main>
<!--footer include -->
...
<!--footer end-->  
  <script type="text/javascript">
    ...
    nhn.husky.EZCreator.createInIFrame({
        ...
        sSkinURI: "../guide/se/SmartEditor2Skin.html", 
        htParams : {
